...
select distinct qmgr.data, qmgr.from_, qmgr.n, smtp.data, smtp.to_ ,smtp.status ,smtp.n
from qmgr 
left join smtp on smtp.n=qmgr.n and hour(qmgr.data)=hour(smtp.data)
left join smtpd on smtpd.n=smtp.n
where qmgr.n='2B347245B';
